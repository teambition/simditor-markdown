      ...
      converters: [
        {
          ...
          replacement: function(innerHTML, node) {
            switch (false) {
              case !(node.parentNode instanceof window.HTMLBodyElement):
                return '<br>';
              case !(node.parentNode instanceof window.HTMLTableCellElement):
                return '';
              case !(node.parentNode instanceof window.HTMLParagraphElement):
